import { e as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, a as renderTemplate, r as renderComponent, b as renderHead, g as renderSlot, f as renderScript } from './astro/server.77ade86.js';
import 'piccolore';
import { $ as $$Image } from './_astro_assets.77ade86.js';
import { $ as $$BaseHead, a as $$Header, b as $$Footer } from './Header.77ade86.js';
import { $ as $$PostDate } from './PostDate.77ade86.js';
import { $ as $$Categories, a as $$Tags } from './Categories.77ade862.js';
import 'clsx';
import { $ as $$Tips } from './Tips.77ade86.js';
import { $ as $$StructuredData } from './StructuredData.77ade86.js';
import { $ as $$Breadcrumb } from './Breadcrumb.77ade86.js';
import { f as filterContent, g as getCollection } from './_astro_content.77ade86.js';
import { g as getPostUrl } from './urls.77ade86.js';
import { $ as $$Comments } from './Comments.77ade86.js';
...
` })} </div>`} </div> ${renderComponent($$result, "FrontMatter", $$FrontMatter, { "data": Astro2.props })} <!-- 文章内容 --> <div class="prose w-full max-w-200 mx-auto"> ${renderSlot($$result, $$slots["default"])} </div> </div> </article> <!-- 上一篇下一篇导航 --> ${renderComponent($$result, "PostNavigation", $$PostNavigation, { "currentPost": {
    ...
    collection: "blog",
    data: Astro2.props
  } })} <!-- 评论区 --> ${renderComponent($$result, "Comments", $$Comments, {})} </main> ${renderComponent($$result, "Footer", $$Footer, {})} <!-- ZoomImage 客户端脚本 --> ${renderScript($$result, "/home/runner/work/obsidian2astro-template/obsidian2astro-template/src/layouts/BlogPost.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
